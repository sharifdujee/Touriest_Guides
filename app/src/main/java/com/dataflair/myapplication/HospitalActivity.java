    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<Model> options =
                new FirebaseRecyclerOptions.Builder<Model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("hospital").child(cityname), Model.class)
                        .build();
...
class HospitalAdapter extends FirebaseRecyclerAdapter<Model, HospitalAdapter.HospitalViewholder> {
    ...
    @Override
    protected void onBindViewHolder(@NonNull HospitalViewholder holder, int position, @NonNull Model model) {
